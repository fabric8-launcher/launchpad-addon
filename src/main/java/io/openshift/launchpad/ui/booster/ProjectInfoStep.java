...
public class ProjectInfoStep implements UIWizardStep
{
    ...
    */
   @Inject
   @WithAttributes(label = "OpenShift Cluster", required = true, type = InputType.RADIO)
   ...
   public Result execute(UIExecutionContext context) throws Exception
   {
      ...
      try
      {
         ...
         if (template != null)
         {
            ...
            values.put("openShiftCluster", openShiftCluster.getValue());
      ...
      returnValue.put("gitHubRepositoryDescription", "Generated by launch.openshift.io");
      returnValue.put("openShiftProjectName", projectName);
      returnValue.put("openShiftCluster", openShiftCluster.getValue());
   ...
   /**
    * Strategy method allowing derived classes to use custom logic to decide if we should show or hide the OpenShift
    * Clusters input
    *
    * @return true if we should show it
    */
   protected boolean isShowOpenShiftClusters()
   {
      return true;
   }
