...
public class ProjectInfoStep implements UIWizardStep
{
   ...
   protected void addDeploymentProperties(UIBuilder builder, DeploymentType deploymentType)
   {
      ...
      {
         String openShiftCluster = (String) builder.getUIContext().getAttributeMap().get("OPENSHIFT_CLUSTER");
         named.setCompleter(Completers.fromValues(missionControlValidator.getProjects(builder.getUIContext(), openShiftCluster)));
